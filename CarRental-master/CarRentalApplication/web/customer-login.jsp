...
<html>
    <head>
        ...
        <!-- css link -->
        <link href="css/customerlogin.css" rel="stylesheet" type="text/css"/>
    ...
    <body>
        ...
        <div class="container-fluid form-section">
            <form name="loginForm" class="form-horizontal" action="CustomerLogin" method="post">
        ...
        <div class="container-fluid register-section">
            <div class="row">
                <div class="col-md-12 text-center">
                    Click <a href="customer-registration.jsp"><span class="link"><strong>register</strong></span></a> to open an account
                </div>
            </div>
        </div>
